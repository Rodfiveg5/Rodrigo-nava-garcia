...
while True:
    ...
    alumno = input("Es alumno de tu clase? (si/no): ").lower()
    
    if alumno == "no":
        print("Lo siento, este sistema es solo para alumnos de la clase.")
        
        break
    else: 
        print("Bienvenido al sistema de autorización para examen final.")
    asistencia = float(
